...
function onLoad() {
  var color = setColorFromParam();
  var size = setSizeFromParam();
...
function handleSizeAndColor(size, color) {
  ...
  if (canvas.getContext) {
    ...
    var dataUrl = canvas.toDataURL();
    var dataUrlTag = document.getElementById('dataurl');
...
function downloadTinySquare(el) {
  ...
  var filename = 'tinysquare-'.concat(getColor(), '-', getSize().toString(), '.png');
